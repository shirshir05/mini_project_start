...
public class TeamController {
    ...
    public ActionStatus AddOrRemoveTeamOwner(String name_team, String TeamOwner, int add_or_remove) {
        ...
        else if (!(DataManagement.containSubscription(TeamOwner) instanceof Busnies_Servic.Business_Layer.UserManagement.TeamOwner)) {
        ...
        // add teamOwner to team
            ...
            Subscription appointed = ((Busnies_Servic.Business_Layer.UserManagement.TeamOwner) teamOwner).getAppointedByTeamOwner();
            if (appointed != null) {
                AC =  new ActionStatus(false, "You are already set as a team owner.");
            }else{
                ((Busnies_Servic.Business_Layer.UserManagement.TeamOwner) teamOwner).setAppointedByTeamOwner(DataManagement.getCurrent());
                AC = team.EditTeamOwner((Busnies_Servic.Business_Layer.UserManagement.TeamOwner) teamOwner, add_or_remove);
            }
        ...
        // remove teamOwner to team
            ...
            if (DataManagement.containSubscription(appointed.getUserName()) != null) {
                ...
                ((Busnies_Servic.Business_Layer.UserManagement.TeamOwner) teamOwner).setAppointedByTeamOwner(null);
                AC = team.EditTeamOwner((Busnies_Servic.Business_Layer.UserManagement.TeamOwner) teamOwner, add_or_remove);
            }
