...
public class TeamController {
    ...
    public ActionStatus AddOrRemoveTeamOwner(String name_team, String TeamOwner, int add_or_remove) {
        ...
        // add teamOwner to team
            ...
            Team team = DataManagement.findTeam(name_team);
            Subscription appointed = ((BusinessService.Business_Layer.UserManagement.TeamOwner) teamOwner).getAppointedByTeamOwner();
            if (appointed != null) {
                AC =  new ActionStatus(false, "You are already set as a team owner.");
            }else{
                ((BusinessService.Business_Layer.UserManagement.TeamOwner) teamOwner).setAppointedByTeamOwner(DataManagement.getCurrent());
                AC = team.EditTeamOwner((BusinessService.Business_Layer.UserManagement.TeamOwner) teamOwner, add_or_remove);
            }
        ...
        // remove teamOwner to team
            ...
            if (appointed != null && DataManagement.containSubscription(appointed.getUserName()) != null) {
                ...
                ((BusinessService.Business_Layer.UserManagement.TeamOwner) teamOwner).setAppointedByTeamOwner(null);
                AC = team.EditTeamOwner((BusinessService.Business_Layer.UserManagement.TeamOwner) teamOwner, add_or_remove);
            }
        }
